...
const LandingPage = () => {
    ...
    return (
        <>
            <section className="grid grid-cols-2 gap-4 py-[5rem] px-[10rem]">
                <div>
                    <Image
                    src={mobileApp}
            ...
            <section className="py-[5rem] px-[10rem]">
                ...
                <div className="parent grid grid-cols-6 grid-rows-3 gap-10 pt-10">
                    <div className="col-span-3 row-span-1 bg-gray-100 p-[2rem]">
                        <span className="text-3xl font-bold">
                        Design a card that's uniquely yours.
                        </span>
                        <p className="text-gray-500">Customize your card with a range of colors, patterns, and designs. Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus quam iure dicta.</p>
                    </div>
                    <div className="col-span-3 row-span-1 bg-gray-100 p-[2rem]">
                        <span className="text-3xl font-bold">
                    ...
                    <div className="col-span-6 row-span-2 bg-gray-100 p-[2rem]">
                        <span className="text-3xl font-bold">
                    ...
                    <div className="col-span-2 row-span-1 bg-gray-100 p-[2rem]">
                        <span className="text-3xl font-bold">
